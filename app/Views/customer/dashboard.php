    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <button class="btn btn-outline-light btn-lg" type="button" data-bs-toggle="modal" data-bs-target="#newMessageModal">My Profile</button>
                ...
                <li class="nav-item">
                <a class="nav-link"  aria-current="page" href="/customer/newmessage" style="color: white">Submit New Message</a>
                </li>
                <li class="nav-item">
                <a class="nav-link"  aria-current="page" href="/customer/messagehistory" style="color: white">Message History</a>
                </li>
    ...
    <div class="container">
        <div class="row mt-5">
            ...
            <div class="d-flex justify-content-between mb-3">
                ...
                <form action="<?= base_url('/dashboard/updateUser')?>" method="post" class="form">
                    <?= csrf_field(); ?>
